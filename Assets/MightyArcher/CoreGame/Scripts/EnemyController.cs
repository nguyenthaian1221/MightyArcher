...
public class EnemyController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Debug.LogError("Mode: " + randomMode);


        switch (randomMode)
        {
            case 0:
                enemySkill = enemySkillLevels.easy;
                break;
            case 1:
                enemySkill = enemySkillLevels.normal;
                break;
            case 2:
                enemySkill = enemySkillLevels.hard;
                break;
            case 3:
                enemySkill = enemySkillLevels.Robinhood;
                break;
